...
// =========================================================
{
  ...
  s.addText("分析の専門知識や経験がなくても、DYNATREKなら業務データから傾向をつかめる", {
  ...
  s.addNotes(
    ...
    "今日お伝えしたいのは、DYNATREKを使えば、データ分析の専門知識や経験がない人でも、業務データを集計して傾向をつかめる、ということです。そして今回は、その一例として、私が実際にやってみた分析をご紹介します。"
  );
  pageNum(s, 1, true);
}
...
// =========================================================
{
  ...
  head(s, "分析の専門知識や経験がなくても、データから傾向はつかめる",
        "ネックになるのは「必要なデータを取り出す」ところ。DYNATREKがそこを引き受けるので、「何を見るか」に時間を使える。");
  ...
  s.addText("今回は、その一例として行った分析を紹介します。", {
  ...
  s.addNotes(
    ...
    "そして今回は、その一例として、私が実際に行った分析をご紹介します。どう考えて、どう集計したのかを見ていただければと思います。"
  );
  pageNum(s, 2);
}
